...
describe('Comtravo Coding Challenge QA', ()=>{
    it('Flight Booking for a Traveller "Sophie lie"',() => {
        ...
        cy.get('.ng-star-inserted',{timeout:90000}).should('contain','Your flight options')
        selectFlight()
        travellerVerification()
        cy.get('button[aria-label="book this flight option"]').click()
        cy.get('[class="confirmation-message"]',{timeout:50000}).should('contain','We received your booking.')
    })
})
